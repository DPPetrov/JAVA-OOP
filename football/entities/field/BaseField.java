...
public abstract class BaseField implements Field {
    ...
    public void addPlayer(Player player) {
        ...
        } else { //виж дали ще работи с else, ако не - махни else, но запази добавянето
            players.add(player);
        }
    }
    ...
    public String getInfo() {
        ...
        String playersReport = getPlayers().isEmpty() ? "none" :
        ...
        return String.format("%s (%s):\n " +
                "Player: %s\n " +
                "Supplement: %d\n " +
                "Energy: %d", name, getClass().getSimpleName(), playersReport, supplements.size(), sumEnergy());
    }
